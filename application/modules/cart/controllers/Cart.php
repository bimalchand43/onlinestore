...
function _check_and_get_session_id($checkout_token){
    //this function call from below index functiom
...
function _create_checkout_token($session_id){
    ...
    //remove dodgy character that show in url(eg =, +, /)
...
function _fetch_cart_contents($session_id, $shopper_id, $table){
    //fetch contents of the shopping cart
    $this->load->module('store_basket');
    $mysql_query = "SELECT $table.*, store_items.small_pic, store_items.iteam_url FROM $table LEFT JOIN store_items ON $table.item_id = store_items.id";
