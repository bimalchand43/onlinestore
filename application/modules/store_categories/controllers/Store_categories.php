...
function view($update_id){
    ...
    //count the items that belongs to this category
    $use_limit = FALSE;
...
function _count_sub_cats($update_id){
    //return number of sub categories belonging to this category
...
function create(){
    ...
    if($submit == "Submit"){
        ...
        if($this->form_validation->run()==TRUE){
            ...
            if(is_numeric($update_id)){
                $this->_update($update_id, $data);
                $flash_msg = "The Category was successfully Updated!!";
                ...
                $flash_msg = "The Category was successfully Created!!";
                $value = '<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
                $this->session->set_flashdata('item', $value);
                redirect('store_categories/create/'.$update_id); 
    ...
    if((is_numeric($update_id)) && ($submit!="submit")){
     ...
     if(!is_numeric($update_id)){
        ...
        $data['headline'] = "Update New Category";
    }
...
function manage(){
    ...
    $data['flash'] = $this->session->flashdata('item');
    $data['view_file'] = "manage_category";
    $this->load->module('templates');
    $this->templates->admin_template($data);
}
