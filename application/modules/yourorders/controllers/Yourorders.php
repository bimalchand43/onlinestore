...
function _get_order_status_option(){
...
function browse(){
    ...
    //count the orders that belongs to this customer
    $use_limit = FALSE;
    ...
    $data['order_status_options'] = $this->_get_order_status_option();
   ...
   /* //fetch the order details
    ...
    $mysql_query = "
        ...
        from
            store_orders
        INNER JOIN store_order_status ON store_orders.order_status = store_order_status.id
        WHERE store_orders.order_ref = '$order_ref'
    ";
