        ...
        <div class="row">
            <div class="col-sm-12">
               <div class="box-content" style="margin-bottom: 15px;">
                   <a href="<?= base_url(); ?>homepage_blocks/manage" style="color: #fff;"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Previous Page</button></a>
                   ...
                   <a href="<?= base_url(); ?>homepage_blocks/deleteconf/<?= $update_id; ?>" style="color: #fff;"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete Entire Offer Block</button></a>
