...
function submit_create(){
    ...
    /*foreach ($_POST as $key => $value) {
           echo "key is $key has value of $value<br>";
       } */  
}

function _draw_create_modal(){
    //model for creating new record
...
function deleteconf($update_id){
    ...
    $data['headline'] = "Delete Entire Offer Blok";
...
function _draw_blocks(){
    //draw the offer blocks that are on the home
...
function view($update_id){
    ...
    //count the items that belongs to this homepage offer
    $use_limit = FALSE;
...
function create(){
    ...
    if($submit == "Submit"){
        ...
        if($this->form_validation->run()==TRUE){
            ...
            if(is_numeric($update_id)){
                $this->_update($update_id, $data);
                $flash_msg = "The Homepage Offer was successfully Updated!!";
                ...
                $flash_msg = "The Homepage Offer was successfully Created!!";
                $value = '<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
                $this->session->set_flashdata('item', $value);
                redirect('btm_nav/create/'.$update_id); 
